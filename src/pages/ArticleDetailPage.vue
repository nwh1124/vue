    ...
    <div class="container mx-auto">
      <div v-if="state.article.id !== undefined" class="flex my-10 bg-white px-6 py-2 shadow-md rounded-lg overflow-hidden mx-auto">
        <div class="flex items-center w-full">
          <div class="w-full">
            <div class="flex flex-row mt-2 py-3 mx-3">
            ...
            <div class="flex w-full border-t border-gray-100">
              ...
              <div class="mt-3 mx-5 w-full flex justify-end">
                <div class="flex text-gray-700 font-normal text-sm rounded-md mb-2 mr-4 items-center whitespace-nowrap">좋아요: <div class="ml-1 text-gray-400 font-thin text-ms"> 120k</div>
                </div>
              </div>
            </div>
            <div class="relative flex items-center self-center w-full max-w-xl p-4 py-4 text-gray-600 focus-within:text-gray-400">
